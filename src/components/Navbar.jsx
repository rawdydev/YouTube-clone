...
const Navbar = () => {
  ...
  border-r-2 border-[#EBEBEB] z-200 pt-[5px]">
    <div className="sidebar-link bg-white flex flex-col lg:flex-row cursor h-[74px] items-center hover:bg-[#EBEBEB]">
      <img className="h-6 lg:px-[15px]"  src="images/icons/home.svg"/>
      <div className="text-[10px]">Home</div>
    </div>
    <div className="sidebar-link bg-white flex flex-col lg:flex-row cursor h-[74px] items-center hover:bg-[#EBEBEB] ">
      <img className="h-6 lg:px-[15px]"  src="images/icons/explore.svg"/>
      <div className="text-[10px]">Explore</div>
    </div>
    <div className="sidebar-link bg-white flex flex-col lg:flex-row cursor h-[74px] items-center hover:bg-[#EBEBEB] ">
      <img className="h-6 lg:px-[15px]"  src="images/icons/subscriptions.svg"/>
      <div className="text-[10px]">Subscriptions</div>
    </div>
    <div className="sidebar-link bg-white flex flex-col lg:flex-row cursor h-[74px] items-center hover:bg-[#EBEBEB] ">
      <img className="h-6 lg:px-[15px]"  src="images/icons/originals.svg"/>
      <div className="text-[10px]">Orginals</div>
    </div>
    <div className="sidebar-link bg-white flex flex-col lg:flex-row cursor h-[74px] items-center hover:bg-[#EBEBEB] ">
      <img className="h-6 lg:px-[15px]"  src="images/icons/YouTube-music.svg"/>
      <div className="text-[10px]">YouTube Music</div>
    </div>
    <div className="sidebar-link bg-white flex flex-col lg:flex-row cursor h-[74px] items-center hover:bg-[#EBEBEB] ">
      <img className="h-6 lg:px-[15px]"  src="images/icons/library.svg"/>
